...
def main():
    ...
    files=list((ROOT/'examples/interact/tools/comparison').glob('*comparison*'))
    files += [ROOT/'examples/interact/tools/comparison/compare_qwen.py',ROOT/'examples/interact/screensim/screensim_compare.sbatch']
