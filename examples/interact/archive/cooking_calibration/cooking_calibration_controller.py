...
def main():
    ...
    stages = [
        ('00-preflight',['python','examples/interact/archive/cooking_calibration/cooking_calibration_preflight.py'],300,{}),
        ('01-kernels',['bash','examples/interact/models/qwen35/qwen35_kernel_stage.sh'],180,{}),
        ('02-train',['bash','examples/interact/archive/cooking_calibration/run_cooking_calibration.sh'],STAGE_LIMITS[2],{}),
        ('03-restore',['bash','examples/interact/archive/cooking_calibration/run_cooking_calibration.sh','--load',checkpoint,
                       '--use-checkpoint-opt-param-scheduler'],600,{'COOKING_RESTORE_ONLY':'1'}),
        ('04-verify',['python','examples/interact/archive/cooking_calibration/cooking_calibration_verify.py'],180,{})]
