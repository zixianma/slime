...
def main():
    ...
    args = parse_args()
    from examples.interact.archive.cooking_calibration.cooking_calibration_budget import split_path, validate_profile
    split = split_path()
    ...
    if full_training:
        from examples.interact.archive.cooking_calibration.cooking_full_training import configure
    ...
    from examples.interact.archive.cooking_calibration.cooking_calibration_actor import CookingAuditActor
    ...
    try:
        ...
        if acceptance:
            ...
            from examples.interact.cooking_gemini.cooking_gpu_handoff import canonical_gpu_uuid
        ...
        if full_training:
            from examples.interact.archive.cooking_calibration.cooking_full_training import train, BudgetPause, write_json
