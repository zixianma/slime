...
python examples/interact/archive/cooking_calibration/train_cooking_calibration.py "${MODEL_ARGS[@]}" \
  ...
  --custom-rollout-log-function-path examples.interact.archive.cooking_calibration.cooking_calibration_metrics.log_rollout \
  --custom-eval-rollout-log-function-path examples.interact.archive.cooking_calibration.cooking_calibration_metrics.log_eval \
