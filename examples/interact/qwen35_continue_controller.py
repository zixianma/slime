...
from examples.interact.qwen35_continue_profile import ROOT, PARENT, ORDER, TARGET
...
def main():
    ...
    stages = [
        ('00-preflight', ['python', 'examples/interact/qwen35_continue_preflight.py'], 180),
        ('01-kernels', ['bash', 'examples/interact/qwen35_kernel_stage.sh'], 180),
        ('02-train', ['bash', 'examples/interact/run_qwen35_train.sh',
            ...
            '--eval-function-path', 'examples.interact.qwen35_continue_eval.generate',
            '--custom-eval-rollout-log-function-path', 'examples.interact.qwen35_continue_eval.log'], 10080),
        ('03-verify', ['python', 'examples/interact/qwen35_continue_verify.py'], 180),
    ]
    try:
