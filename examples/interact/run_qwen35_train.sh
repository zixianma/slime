...
python examples/interact/train_qwen35_vl.py "${MODEL_ARGS[@]}" \
  ...
  --custom-rollout-log-function-path examples.interact.qwen35_metrics.log_rollout \
  --custom-eval-rollout-log-function-path examples.interact.qwen35_metrics.log_eval \
