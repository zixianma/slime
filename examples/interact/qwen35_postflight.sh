...
python examples/interact/verify_qwen35_run.py --run-dir "$Q35_RESULT"
...
INTERACT_ATTEMPT="restore-${Q35_PILOT_ATTEMPT:-pilot05}" bash examples/interact/run_qwen35_checked.sh \
