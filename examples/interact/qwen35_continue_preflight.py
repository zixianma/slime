...
from examples.interact.qwen35_continue_profile import (
...
subprocess.run(['python','examples/interact/qwen35_provenance.py','--output',str(job/'provenance.json')], check=True)
