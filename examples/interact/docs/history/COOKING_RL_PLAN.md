...
Readiness check: `../.venv/bin/python examples/interact/archive/cooking_calibration/cooking_calibration_budget.py`
from the Slime directory. Once compute is explicitly approved, submit
`sbatch examples/interact/archive/cooking_calibration/cooking_qwen35_calibration.sbatch`.
